	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				...
				<li class="dropdown <?php if($controller == 'menu') { echo 'active'; } ?>">
					...
					<ul class="dropdown-menu">
						<li><a href="<?php echo site_url('menu'); ?>">Semua Menu</a></li>
						<li role="separator" class="divider"></li>
						<li><a href="<?php echo site_url('menu/list-menu'); ?>">List Menu</a></li>
						<li><a href="<?php echo site_url('menu/kategori'); ?>">Kategori Menu</a></li>
					</ul>
				</li>

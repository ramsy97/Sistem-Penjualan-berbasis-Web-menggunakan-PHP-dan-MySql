			...
			<div class='row'>
				<div class='col-sm-3'>
					<div class="panel panel-primary">
						<div class="panel-heading"><i class='fa fa-file-text-o fa-fw'></i> Informasi Pesanan</div>
						<div class="panel-body">
							...
							<div class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-sm-8">
										...
										foreach($transaksi->result() as $is){

											$res = $is->ids+1;?>
										<input type='text' name='nomor_nota' class='form-control input-sm' id='nomor_nota' value="<?php echo strtoupper(date('Ymd')).$res.$this->session->userdata('ap_id_user'); ?>" <?php echo $readonly; ?>>
...
$(document).on('keyup', '#pencarian_kode', function(e){
	if($(this).val() !== '')
	{
		...
		else if(charCode == 13)
		{
			...
			var Menunya = Field.find('div#hasil_pencarian li.autocomplete_active span#menunya').html();
			...
			$('#TabelTransaksi tbody tr:eq('+$(this).parent().parent().index()+') td:nth-child(3)').html(Menunya);
...
$(document).on('click', '#daftar-autocomplete li', function(){
	...
	var NamaMenu = $(this).find('span#menunya').html();

...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-cube fa-fw'></i> Menu <i class='fa fa-angle-right fa-fw'></i> Kategori</h5>
			<hr />
...
{
	$tambahan .= nbs(2)."<a href='".site_url('menu/tambah-kategori')."' class='btn btn-default' id='TambahKategori'><i class='fa fa-plus fa-fw'></i> Tambah Kategori</a>";
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#my-grid').DataTable( {
			...
			"ajax":{
				url :"<?php echo site_url('menu/kategori-json'); ?>",
				type: "post",
				error: function(){ 
					$(".my-grid-error").html("");
